...
const sendMail = async (to, subject, html) => {
    ...
    const mailOptions = {
        from: `"DocApp" <${process.env.MAIL_FROM}>`,
        to,
        subject,
        html,
    };
...
const sendCancellationEmail =
    (to, patientName, doctorName, date, reason) =>
        sendMail(
            to,
...
const sendBookingConfirmationEmail =
    (to, patientName, doctorName, date, slot, tokenNo, otp) =>
        sendMail(
            to,
            ...
            <div style="font-family:sans-serif;max-width:480px;margin:auto">
                ...
                <table style="border-collapse:collapse;width:100%">
                    ...
                    <tr>
                        ...
                        <td style="font-size:1.4rem;font-weight:bold">
                            ${tokenNo}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:6px">
                            <strong>Consultation OTP</strong>
                        </td>

                        <td style="font-size:1.4rem;letter-spacing:4px;color:#2563EB">
                            ${otp}
                        </td>
                    </tr>
                ...
                <p style="color:#6b7280;font-size:0.85rem">
                    Present this OTP to the doctor at the time of consultation.
                </p>
